...
define('calc/tests/integration/components/calc-button-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | calc-button', function (hooks) {
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "co5i6797",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"calc-button\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "6ObM1Klm",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"calc-button\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('calc/tests/integration/components/calc-display-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | calc-display', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "RnmRyEwC",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"calc-display\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "750vixQT",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"calc-display\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('calc/tests/lint/app.lint-test', [], function () {
  ...
  QUnit.test('components/calc-display.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/calc-display.js should pass ESLint\n\n47:9 - \'result\' is assigned a value but never used. (no-unused-vars)\n53:9 - Unreachable code. (no-unreachable)\n58:9 - Unreachable code. (no-unreachable)\n63:9 - Unreachable code. (no-unreachable)\n68:9 - Unreachable code. (no-unreachable)\n72:11 - Unreachable code. (no-unreachable)');
  });
...
define('calc/tests/lint/templates.template.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('calc/templates/components/calc-display.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'calc/templates/components/calc-display.hbs should pass TemplateLint.\n\ncalc/templates/components/calc-display.hbs\n  22:4  error  Incorrect indentation for `<div>` beginning at L22:C4. Expected `<div>` to be at an indentation of 2 but was found at 4.  block-indentation\n  49:4  error  Incorrect indentation for `<div>` beginning at L49:C4. Expected `<div>` to be at an indentation of 2 but was found at 4.  block-indentation\n  75:4  error  Incorrect indentation for `<div>` beginning at L75:C4. Expected `<div>` to be at an indentation of 2 but was found at 4.  block-indentation\n  101:4  error  Incorrect indentation for `<div>` beginning at L101:C4. Expected `<div>` to be at an indentation of 2 but was found at 4.  block-indentation\n  21:10  error  Incorrect indentation for `div` beginning at L3:C2. Expected `</div>` ending at L21:C10 to be at an indentation of 2 but was found at 4.  block-indentation\n  7:6  error  Incorrect indentation for `<div>` beginning at L7:C6. Expected `<div>` to be at an indentation of 4 but was found at 6.  block-indentation\n  15:6  error  Incorrect indentation for `<div>` beginning at L15:C6. Expected `<div>` to be at an indentation of 4 but was found at 6.  block-indentation\n  27:10  error  Duplicate attribute \'pressNum\' found in the MustacheStatement.  no-duplicate-attributes\n  129:0  error  Unexpected {{outlet}} usage. Only use {{outlet}} within a route template.  no-outlet-outside-routes\n  17:20  error  you must use double quotes in templates  quotes\n  25:20  error  you must use double quotes in templates  quotes\n  32:20  error  you must use double quotes in templates  quotes\n  38:20  error  you must use double quotes in templates  quotes\n  44:20  error  you must use double quotes in templates  quotes\n  52:20  error  you must use double quotes in templates  quotes\n  58:20  error  you must use double quotes in templates  quotes\n  64:20  error  you must use double quotes in templates  quotes\n  70:20  error  you must use double quotes in templates  quotes\n  78:20  error  you must use double quotes in templates  quotes\n  84:20  error  you must use double quotes in templates  quotes\n  90:20  error  you must use double quotes in templates  quotes\n  96:20  error  you must use double quotes in templates  quotes\n  104:20  error  you must use double quotes in templates  quotes\n  110:20  error  you must use double quotes in templates  quotes\n  116:20  error  you must use double quotes in templates  quotes\n  122:20  error  you must use double quotes in templates  quotes\n');
  });
});
...
define('calc/tests/test-helper', ['calc/app', 'calc/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
require('calc/tests/test-helper');
