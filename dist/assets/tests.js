...
define('calc/tests/lint/app.lint-test', [], function () {
  ...
  QUnit.test('components/calc-button.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/calc-button.js should pass ESLint\n\n');
  });
...
define('calc/tests/lint/templates.template.lint-test', [], function () {
  ...
  QUnit.test('calc/templates/components/calc-display.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'calc/templates/components/calc-display.hbs should pass TemplateLint.\n\ncalc/templates/components/calc-display.hbs\n  28:4  error  Incorrect indentation for `<div>` beginning at L28:C4. Expected `<div>` to be at an indentation of 2 but was found at 4.  block-indentation\n  54:4  error  Incorrect indentation for `<div>` beginning at L54:C4. Expected `<div>` to be at an indentation of 2 but was found at 4.  block-indentation\n  80:4  error  Incorrect indentation for `<div>` beginning at L80:C4. Expected `<div>` to be at an indentation of 2 but was found at 4.  block-indentation\n  106:4  error  Incorrect indentation for `<div>` beginning at L106:C4. Expected `<div>` to be at an indentation of 2 but was found at 4.  block-indentation\n  27:10  error  Incorrect indentation for `div` beginning at L2:C2. Expected `</div>` ending at L27:C10 to be at an indentation of 2 but was found at 4.  block-indentation\n  14:6  error  Incorrect indentation for `<div>` beginning at L14:C6. Expected `<div>` to be at an indentation of 4 but was found at 6.  block-indentation\n  13:12  error  Incorrect indentation for `div` beginning at L6:C4. Expected `</div>` ending at L13:C12 to be at an indentation of 4 but was found at 6.  block-indentation\n  134:0  error  Unexpected {{outlet}} usage. Only use {{outlet}} within a route template.  no-outlet-outside-routes\n  17:22  error  you must use double quotes in templates  quotes\n  22:22  error  you must use double quotes in templates  quotes\n  31:20  error  you must use double quotes in templates  quotes\n  37:20  error  you must use double quotes in templates  quotes\n  43:20  error  you must use double quotes in templates  quotes\n  49:20  error  you must use double quotes in templates  quotes\n  57:20  error  you must use double quotes in templates  quotes\n  63:20  error  you must use double quotes in templates  quotes\n  69:20  error  you must use double quotes in templates  quotes\n  75:20  error  you must use double quotes in templates  quotes\n  83:20  error  you must use double quotes in templates  quotes\n  89:20  error  you must use double quotes in templates  quotes\n  95:20  error  you must use double quotes in templates  quotes\n  101:20  error  you must use double quotes in templates  quotes\n  109:20  error  you must use double quotes in templates  quotes\n  115:20  error  you must use double quotes in templates  quotes\n  121:20  error  you must use double quotes in templates  quotes\n  127:20  error  you must use double quotes in templates  quotes\n');
  });
});
